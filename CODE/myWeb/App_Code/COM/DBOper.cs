...
public class DBOper
{
    ...
    public static OleDbCommand CreateCommandDBCon()
    {
        ...
        //Provider=SQLOLEDB;Data Source=(local);User ID=sa;password=111;
        
        string connectionString = "Provider=SQLOLEDB;data source=dell-pc;initial catalog=myDB;Integrated Security=SSPI";
